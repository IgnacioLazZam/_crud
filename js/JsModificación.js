document.getElementById("miFormulario").addEventListener("submit", function(event) {
    ...
    var nombreHelp = document.getElementById(inputNombre.id + "help");
...
document.getElementById("miFormulario").addEventListener("submit", function(event) {
    ...
    var usernameHelp = document.getElementById(inputUserName.id + "help");
...
document.getElementById("miFormulario").addEventListener("submit", function(event) {
    ...
    var cicloHelp = document.getElementById(selectCiclo.id + "help");
